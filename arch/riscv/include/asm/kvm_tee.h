...
int kvm_riscv_tee_vcpu_imsic_unbind(struct kvm_vcpu *vcpu, int old_cpu);
...
static inline int kvm_riscv_tee_vcpu_imsic_unbind(struct kvm_vcpu *vcpu, int old_cpu) {return -1;}
static inline int kvm_riscv_tee_vcpu_imsic_bind(struct kvm_vcpu *vcpu, unsigned long imsic_mask) {return -1;}
static inline int kvm_riscv_tee_aia_claim_imsic(struct kvm_vcpu *vcpu, phys_addr_t imsic_pa) {return -1;}
...
static inline int kvm_riscv_tee_vcpu_imsic_rebind(struct kvm_vcpu *vcpu, int old_pcpu) {return -1;}
