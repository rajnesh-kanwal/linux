...
#define CTRCONTROL_S_ENABLE            _AC(0x2, UL)
#define CTRCONTROL_U_ENABLE            _AC(0x4, UL)
#define CTRCONTROL_CLR                 _AC(0x80, UL)
#define CTRCONTROL_MTE                 _AC(0x100, UL)
#define CTRCONTROL_STE                 _AC(0x200, UL)
#define CTRCONTROL_RASEMU              _AC(0x400, UL)
#define CTRCONTROL_BPFRZ               _AC(0x1000, UL)
#define CTRCONTROL_LCOFIFRZ            _AC(0x2000, UL)
#define CTRCONTROL_DEPTH_MASK          _AC(0xF0000, UL)
...
#define CTRCONTROL_INDJUMP_INH         _AC(0x40000000000, UL)
#define CTRCONTROL_DIRJUMP_INH         _AC(0x80000000000, UL)
#define CTRCONTROL_CORSWAP_INH         _AC(0x100000000000, UL)
#define CTRCONTROL_RET_INH             _AC(0x200000000000, UL)
#define CTRCONTROL_INDOJUMP_INH        _AC(0x400000000000, UL)
...
# define CSR_CTRSTATUS      CSR_MCTRSTATUS
